...
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group row col my-2">
                <label for="">IC number</label>
                <input type="text" class="form-control" name="icno" id="ic" placeholder="eg: 123456-12-1234" pattern="[0-9]{6}-[0-9]{2}-[0-9]{4}">
            </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            if (preg_match($icPattern, $ic)) {
                if (checkdate($months, $day, $year)) {
                    echo "Birthday: " . strtoupper($month[$months - 1]) . " " . $day . ", " . $year . "<br>";
                    echo "Chinese Zodiac: " . $Czodiac[$i] . ".<br>";
                    echo "Star Zodiac: " . $zodiac . ".<br>";
                    echo "IC Number: " . $ic;
                } else {
                    echo "Please select the valid date.";
                }
            } else {
                echo "Please enter the correct IC Number.";
            }
        }
        ?>
    </div>
